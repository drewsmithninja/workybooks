    ...
    <Header className="h-20 flex justify-between items-center bg-white xl:px-10 lg:px-8 md:px-6 px-0">
        ...
        <div className="hidden space-x-4 md:flex">
          <Link to="/" className="hover:text-[#243E8F]">
            {window.location.pathname === '/' ? (
              <span className="navbar-menu-item active-menu">Explore</span>
            ) : (
              <span className="navbar-menu-item">Explore</span>
            )}
          </Link>
          <Link to="/my-library">
            {window.location.pathname === '/my-library' ? (
              <span className="navbar-menu-item active-menu">My Library</span>
            ) : (
      ...
      <div className="md:hidden z-10">
        <div
          id="menu"
          ref={navbarRef}
          className="bg-white border border-solid border-primary absolute flex-col items-center hidden self-end font-bold mt-6 left-0 rounded-md border-t-0 right-0 sm:w-auto sm:self-center">
          <Link
            to="/"
            className="hover:bg-primary rounded-md h-10 w-full hover:text-white flex items-center justify-center">
            <span className="navbar-menu-item">Explore</span>
          </Link>
          <Link
            to="/my-library"
