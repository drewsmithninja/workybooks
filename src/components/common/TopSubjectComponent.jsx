    ...
    <div className="text-center md:text-left !mt-[20px] xl:mx-16 mx-2">
      <Row gutter={16}>
        <Col
          ...
          md={16}
          lg={16}
          className="border-b md:border-solid border-x-0 border-t-0 pb-3">
          <Typography.Text className="font-bold text-[11px] sm:mb-0 !mb-[20px] block">
            Browse by Subject
          </Typography.Text>
        ...
        <Col
          ...
          md={8}
          lg={8}
          className="text-center md:text-left !p-0 border-b md:border-solid border-x-0 border-t-0 pb-3">
          <Typography.Text className="font-bold text-[11px] md:ml-[10px] w-full  mb-[20px] block">
            Browse by Common core standards
          </Typography.Text>
