...
function ManualContent({ setManualStep }) {
  return (
    <>
      ...
      <Typography.Title
        level={5}
        className="!font-normal !mt-[16px] !mb-[60px] !text-[14px] text-center">
      ...
      <Row gutter={[16, 16]}>
          ...
          <Form>
            <Form.Item label={false}>
              <Input
                ...
                className="w-[384px] h-[46px] rounded-[8px] mb-[55px]"
              />
            </Form.Item>
          </Form>
        </Col>
        <Col span={24} className="text-center">
          ...
          <div className="w-[80%] m-auto">
            <Row gutter={[16, 16]}>
              <Col span={6}>
                <ADButton className="bg-gray-300 w-[58px] h-[25px] rounded-[60px] text-[12px]">
                  K
                </ADButton>
              </Col>
              <Col span={6}>
