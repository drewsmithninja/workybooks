              ...
              {assignments?.length &&
                assignments.map((assignment) => (
                  <Row
                    ...
                    onClick={() => addToAssignmentHandler(assignment)}>
                    <Col flex="none">
                      <ADImage
                        src={assignment.content?.[0]?.thumbnail}
                        onError={(e) => (e.target.src = dummyImage)}
                        className="h-auto w-[75px] aspect-[4/3] rounded-lg object-cover"
                      />
                    </Col>
