              ...
              <Row gutter={16} className="text-gray-400 pt-6 pb-5">
                ...
                <Col lg={8} className="flex items-center border-y-0 border-l-0 border-solid">
                  <ADButton
                    ...
                    type="text"
                    className="text-left text-gray-400 !p-0 !m-0">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-2xl flex mx-2">
                    <ADButton
                      onClick={copyHandler}
                      type="text"
                      className="!p-0 text-gray-400 flex items-center w-full">
                      {!copied ? (
                        <FaLink className="text-xl px-px" />
                      ) : (
                        <BsFillCheckCircleFill className="text-primary text-2xl font-bold" />
                      )}
                    </ADButton>
                  </div>
                </div>
