...
function SearchResult() {
  ...
  const collectionData = useMemo(() => {
    ...
    if (sortBy !== '') {
      console.log("collectionData loader true")
      setLoader(true)
      if (sortBy === 'title') {
      ...
      sortedData = [...sortedData, ...noData];
      setTimeout(() => {
        console.log("collectionData loader false")
        setLoader(false)
      }, 1000)
      setCollectionLoader(false);
      return sortedData;
        ...
        <div className='flex flex-1 pt-[15px]'>
          <Row gutter={[16, 16]} className='flex flex-1 !m-0'>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "100%", paddingRight: 10 }}>
              ...
              {worksheets?.length + collections.length ? <Space>
            ...
            {isSearchResultLoading || loader ? <div style={{ marginTop: 50, display: "flex", width: "70vw", justifyContent: "center", alignItems: "center" }}><Spinner /></div>
              : <div>
                {/* Collections */}
                <div>
